...
import kotlinx.android.synthetic.main.item_srchhospital.view.*


class HospListAdapter(
    private var items: ArrayList<CategoryItemModel>,
) : RecyclerView.Adapter<HospListAdapter.NavigationItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NavigationItemViewHolder {
        ...
        val navItem =
            LayoutInflater.from(parent.context).inflate(R.layout.item_srchhospital, parent, false)
